...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mTraffic, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock, mLeftClock, mBrokenLogo;
    ...
    public void init() {
        ...
        mBrokenLogo = mView.findViewById(R.id.broken_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mBrokenLogo, newAlphaBC)
                    );
            ...
            mBrokenLogo.setAlpha(newAlphaBC);
        }
    }
}
