...
static sp<ISlimPowerV1_0> gSlimPowerHalV1_0_ = nullptr;
static bool gPowerHalExists = true;
static bool gSlimPowerHalExists = true;
...
void connectSlimPowerHalLocked() {
    if (gSlimPowerHalExists && gSlimPowerHalV1_0_ == nullptr) {
        gSlimPowerHalV1_0_ = ISlimPowerV1_0::getService();
        if (gSlimPowerHalV1_0_ != nullptr) {
...
// Retrieve a copy of SlimPowerHAL V1_0
sp<ISlimPowerV1_0> getSlimPowerHalV1_0() {
    std::lock_guard<std::mutex> lock(gPowerHalMutex);
    connectSlimPowerHalLocked();
    return gSlimPowerHalV1_0_;
}
...
static jint nativeGetFeature(JNIEnv* /* env */, jclass /* clazz */, jint featureId) {
    ...
    sp<ISlimPowerV1_0> slimPowerHalV1_0 = getSlimPowerHalV1_0();
    if (slimPowerHalV1_0 != nullptr) {
        value = slimPowerHalV1_0->getFeature(static_cast<SlimFeature>(featureId));
    }
