...
import com.android.internal.util.broken.DevUtils;
import com.android.internal.util.broken.DimensionConverter;
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void interceptPowerKeyDown(KeyEvent event, boolean interactive) {
        ...
        mPowerKeyHandled = hungUp || mVolumeDownKeyTriggered || mVolumeUpKeyTriggered;
        if (!mPowerKeyHandled) {
            if (interactive) {
        ...
        mHandler.post(new Runnable() {
            @Override public void run() {
                if (mBootMsgDialog == null) {
                    ...
                    mBootMsgDialog.setIcon(com.android.internal.R.drawable.brokencuffs_tint);
